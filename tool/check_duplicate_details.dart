...
Future<void> main() async {
  ...
  print('=== CHECKING DUPLICATE DOC QUANTITIES AND CREATION TIMES ===');
  for (final entry in groups.entries) {
    if (entry.value.length > 1) {
      print('\nMedicine Group: ${entry.key}');
      for (final doc in entry.value) {
        print('  docId: ${doc['id']}');
        print('    qty: ${doc['quantity']}, exp: ${doc['expiryDate']}, barcode: ${doc['barcode']}, createdAt: ${doc['createdAt']}, lastUpdated: ${doc['lastUpdated']}');
      }
    }
  }
}
